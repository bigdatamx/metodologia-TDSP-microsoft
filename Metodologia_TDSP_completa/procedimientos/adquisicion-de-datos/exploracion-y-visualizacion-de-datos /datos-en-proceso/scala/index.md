---
title: Ciencia de datos mediante Scala y Spark en Azure
---
...
![Configuración de tipo de clúster de HDInsight](https://s3.amazonaws.com/bigdatamx/TDSP1-spark-cluster-on-portal.png)
...
![Panel del clúster y cuadernos de Jupyter Notebook](https://s3.amazonaws.com/bigdatamx/TDSP2-spark-jupyter-on-portal.png)
...
![Vaya a Jupyter Notebook mediante el nombre de clúster](https://s3.amazonaws.com/bigdatamx/TDSP3-spark-jupyter-notebook.png)
...
![Histograma del importe de la propina](https://s3.amazonaws.com/bigdatamx/TDSP4-plot-tip-amount-histogram.png)

![Importe de las propinas por número de pasajeros](https://s3.amazonaws.com/bigdatamx/TDSP5-plot-tip-amount-by-passenger-count.png)

![Importe de las propinas por importe de la tarifa](https://s3.amazonaws.com/bigdatamx/TDSP6-plot-tip-amount-by-fare-amount.png)
...
![Curva de ROC sobre si se dará propina o no](https://s3.amazonaws.com/bigdatamx/TDSP5-logistic-regression-roc-curve.png)
...
![Importe de la propina: real frente a predicción](https://s3.amazonaws.com/bigdatamx/TDSP6-actual-vs-predicted-tips.png)
