---
title: Panel de Power BI de hábitos de mantenimiento y conducción de vehículos (Azure)
---
...
3. Ejecute la aplicación RealtimeDashboardApp.exe. En la ventana de inicio de sesión, escriba sus credenciales válidas de Power BI. 
   ...
   ![Ventana de inicio de sesión de Power BI](https://s3.amazonaws.com/bigdatamx/TDSP5-sign-into-powerbi.png)
   
4. Seleccione **Aceptar**. La aplicación comienza a ejecutarse.

   ![Permisos del panel de Power BI](https://s3.amazonaws.com/bigdatamx/TDSP6-powerbi-dashboard-permissions.png)
...
1. Vaya a la página web de [Power BI](http://powerbi.com) e inicie sesión.
    ...
    ![Página de inicio de sesión de Power BI](https://s3.amazonaws.com/bigdatamx/TDSP6-1-powerbi-signin.png)

2. Se genera un nuevo conjunto de datos en Power BI. Seleccione el conjunto de datos **ConnectedCarsRealtime**.

    ![Conjunto de datos ConnectedCarsRealtime](https://s3.amazonaws.com/bigdatamx/TDSP7-select-connected-cars-realtime-dataset.png)

3. Para guardar el informe en blanco, presione CTRL+S.

    ![Informe en blanco](https://s3.amazonaws.com/bigdatamx/TDSP8-save-blank-report.png)

4. Escriba el nombre del informe **Análisis de telemetría del vehículo en tiempo real - Informes**.

    ![Nombre del informe](https://s3.amazonaws.com/bigdatamx/TDSP9-provide-report-name.png)
...
1. Haga doble clic en **Página 1** y cambie el nombre de la página por **Vehículos en funcionamiento**.
    ...
    ![Vehículos en funcionamiento](https://s3.amazonaws.com/bigdatamx/TDSP91-1-connected-cars-3.4a.png)  
...
2. En la pestaña **Campos**, seleccione **vin**. En la pestaña **Visualizaciones**, seleccione la visualización **Tarjeta**.  
    ...
    ![Selección de vin](https://s3.amazonaws.com/bigdatamx/TDSP9-2connected-cars-3.4b.png)
...
4. En la pestaña **Campos**, seleccione **city** y **vin**. En la pestaña **Visualizaciones**, seleccione la visualización **Mapa**. Arrastre **vin** al área **Valores**. Arrastre **city** al área **Leyenda**. 
    ...
    ![Visualización de tarjeta](https://s3.amazonaws.com/bigdatamx/TDSP9-3-connected-cars-3.4c.png)
...
5. En la pestaña **Visualizaciones**, seleccione la sección **Formato**. Seleccione **Título** y cambie el **texto** a **Vehículos en funcionamiento por ciudad**.
    ...
    ![Vehículos en funcionamiento por ciudad](https://s3.amazonaws.com/bigdatamx/TDSP9-4-connected-cars-3.4d.png)   

    La visualización final es parecida a la del ejemplo siguiente:

    ![Visualización final](https://s3.amazonaws.com/bigdatamx/TDSP9-5-connected-cars-3.4e.png)
...
8. Ordene el gráfico por **Recuento de vin**.	
    ...
    ![Recuento de vin](https://s3.amazonaws.com/bigdatamx/TDSP9-6-connected-cars-3.4f.png)  
...
10. Seleccione la sección **Formato** y, a continuación, seleccione **Colores de datos**. Cambie **Mostrar todo** a **Activado**.
    ...
    ![Colores de datos](https://s3.amazonaws.com/bigdatamx/TDSP9-7-connected-cars-3.4g.png	)  

11. Cambie el color de una ciudad mediante la selección del símbolo de color.

    ![Cambio de color](https://s3.amazonaws.com/bigdatamx/TDSP9-8-connected-cars-3.4h.png)  
...
13. En la pestaña **Visualizaciones**, seleccione la visualización **Gráfico de columnas agrupadas**. En la pestaña **Campos**, arrastre **city** al área **Eje**. Arrastre **Model** al área **Leyenda**. Arrastre **vin** al área **Valor**.
    ...
    ![Gráfico de columnas agrupadas](https://s3.amazonaws.com/bigdatamx/TDSP9-9-connected-cars-3.4i.png)

    El gráfico es similar a la siguiente imagen:

    ![Representación](https://s3.amazonaws.com/bigdatamx/TDSP-9-10-connected-cars-3.4j.png)

14. Reorganice todas las visualizaciones para que la página tenga un aspecto similar al ejemplo siguiente:

    ![Panel con visualizaciones](https://s3.amazonaws.com/bigdatamx/TDSP9-11-connected-cars-3.4k.png)
...
1. Seleccione ![Agregar](https://s3.amazonaws.com/bigdatamx/TDSPconnected-cars-3.4add.png) para agregar un nuevo informe. Cambie el nombre por **Vehículos que requieren mantenimiento**.

    ![Vehículos que requieren mantenimiento](https://s3.amazonaws.com/bigdatamx/TDSP-9-12-connected-cars-3.4l.png)  

2. En la pestaña **Campos**, seleccione **VIN**. En la pestaña **Visualizaciones**, seleccione la visualización **Tarjeta**.

    ![Visualización de tarjeta de VIN](https://s3.amazonaws.com/bigdatamx/TDSP-9-13-connected-cars-3.4m.png)  
...
3. Para agregar un **filtro de nivel de página** para mostrar los datos de los vehículos que requieren mantenimiento, siga estos pasos: 
   ...
   a. Arrastre el campo **MaintenanceLabel** a **Filtros de nivel de página**.
      ...
      ![Filtros de nivel de página](https://s3.amazonaws.com/bigdatamx/TDSP-9-14connected-cars-3.4n1.png)

    b. En la parte inferior de **Filtros de nivel de página de MaintenanceLabel**, seleccione **Filtrado básico**.

      ![Filtrado básico](https://s3.amazonaws.com/bigdatamx/TDSP9-15-connected-cars-3.4n2.png) 

    c. Establezca el valor de filtro en **1**.

      ![Valor de filtro](https://s3.amazonaws.com/bigdatamx/TDSP-9-16-connected-cars-3.4n3.png)  
...
5. En la pestaña **Visualizaciones**, seleccione la visualización **Gráfico de columnas agrupadas**. 
    ...
    ![Tarjeta de VIN](https://s3.amazonaws.com/bigdatamx/TDSP10-connected-cars-3.4o.png)

    ![Gráfico de columnas agrupadas](https://s3.amazonaws.com/bigdatamx/TDSPconnected-cars-3.4p.png)
...
7. En la sección **Campos** ![Campos](https://s3.amazonaws.com/bigdatamx/TDSPconnected-cars-3.4field.png) de la pestaña **Visualizaciones**, arrastre **vin** a **Saturación de color**.

    ![Saturación de color](https://s3.amazonaws.com/bigdatamx/TDSP10-2-connected-cars-3.4q.png)  
...
8. En la sección **Formato**, cambie los **colores de datos** de la visualización: 
    ...
    ![Nuevos colores de datos](https://s3.amazonaws.com/bigdatamx/TDSP11-connected-cars-3.4r.png)

    Los nuevos colores de visualización se parecen al ejemplo siguiente:

    ![Nuevos colores de visualización](https://s3.amazonaws.com/bigdatamx/TDSP12-connected-cars-3.4s.png)  
...
10. En la pestaña **Visualizaciones**, seleccione **Gráfico de columnas agrupadas**. Arrastre **vin** al área **Valor**. Arrastre **city** al área **Eje**. Ordene el gráfico por **Recuento de vin**. Cambie el **título** del gráfico a **Vehículos que necesitan mantenimiento por ciudad**.
    ...
    ![Vehículos que requieren mantenimiento por ciudad](https://s3.amazonaws.com/bigdatamx/TDSP13-connected-cars-3.4t.png)
...
12. En la pestaña **Visualizaciones**, seleccione la visualización **Tarjeta de varias filas**. Arrastre **Model** y **vin** al área **Campos**.
    ...
    ![Tarjeta de varias filas](https://s3.amazonaws.com/bigdatamx/TDSP14-connected-cars-3.4u.png)    

13. Reorganice todas las visualizaciones para que el informe final sea similar al ejemplo siguiente: 

    ![Reorganización del informe final](https://s3.amazonaws.com/bigdatamx/TDSP15-connected-cars-3.4v.png)  
...
1. Seleccione ![Agregar](https://s3.amazonaws.com/bigdatamx/TDSPconnected-cars-3.4add.png) para agregar un nuevo informe. Cambie el nombre por **Estadísticas de mantenimiento de vehículos**. 
...
2. En la pestaña **Visualizaciones**, seleccione la visualización **Indicador**. Arrastre **speed** a las áreas **Valor**, **Valor mínimo** y **Valor máximo**.
   ...
   ![Estadísticas de estado de los vehículos](https://s3.amazonaws.com/bigdatamx/TDSP16-connected-cars-3.4w.png)  
...
5. En el área **Valor máximo**, cambie la agregación predeterminada de **speed** a **Máximo**.
   ...
   ![Valores de velocidad](https://s3.amazonaws.com/bigdatamx/TDSP17-connected-cars-3.4x.png)  

6. Cambie el nombre del **título del indicador** a **Velocidad media**.

   ![Indicador](https://s3.amazonaws.com/bigdatamx/TDSP18-connected-cars-3.4y.png)  
...
8. Cambie la agregación predeterminada de los campos de cada indicador como hizo en los pasos anteriores con el indicador de **Velocidad media**.
    ...
    ![Indicadores adicionales](https://s3.amazonaws.com/bigdatamx/TDSP19-connected-cars-3.4z.png)
...
11. Arrastre **engineTemperature** al área **Valores de líneas**. Cambie el tipo de agregación a **Media**. 
    ...
    ![Valores de líneas y columnas](ttps://s3.amazonaws.com/bigdatamx/TDSP20-connected-cars-3.4aa.png)
...
12. Cambie el **título** del gráfico a **Valores medios de velocidad, presión de los neumáticos, aceite del motor y temperatura del motor**.  
    ...
    ![Título del gráfico de columnas agrupadas y de líneas](https://s3.amazonaws.com/bigdatamx/TDSP21-connected-cars-3.4bb.png)
...
15. Cambie el **título** del gráfico a **Modelos de vehículo que necesitan mantenimiento**.
    ...
    ![Título de Treemap](https://s3.amazonaws.com/bigdatamx/TDSP22-connected-cars-3.4cc.png)
...
17. En la pestaña **Visualizaciones**, seleccione la visualización **Gráfico de barras 100 % apiladas**. Arrastre **city** al área **Eje**. Arrastre **MaintenanceProbability** y **RecallProbability** al área **Valor**.
    ...
    ![Áreas de eje y valor](https://s3.amazonaws.com/bigdatamx/TDSP23-connected-cars-3.4dd.png)
...
19. Cambie el **título** del gráfico a **Probabilidad de mantenimiento del vehículo y retirada por ciudad**.
    ...
    ![Título del gráfico de barras 100 % apiladas](https://s3.amazonaws.com/bigdatamx/TDSP24-connected-cars-3.4ee.png)
...
21. En la pestaña **Visualizaciones**, seleccione la visualización **Gráfico de áreas**. Arrastre **Model** al área **Eje**. Arrastre **engineOil**, **tirepressure**, **speed** y **MaintenanceProbability** al área **Valores**. Cambie su tipo de agregación por **Media**. 
    ...
    ![Tipo de agregación](https://s3.amazonaws.com/bigdatamx/TDSP25-connected-cars-3.4ff.png)
...
22. Cambie el **título** del gráfico por **Media de aceite del motor, presión de los neumáticos, velocidad y probabilidad de mantenimiento por modelo**.
    ...
    ![Título del gráfico de áreas](https://s3.amazonaws.com/bigdatamx/TDSP26-connected-cars-3.4gg.png)
...
24. En la pestaña **Visualizaciones**, seleccione la visualización **Gráfico de dispersión**. Arrastre **Model** a las áreas **Detalles** y **Leyenda**. Arrastre **fuel** al área **Eje X**. Cambie la agregación a **Media**. Arrastre **engineTemperature** al área **Eje Y**. Cambie la agregación a **Media**. Arrastre **vin** al área **Tamaño**.
    ...
    ![Áreas Detalles, Leyenda, Eje y Tamaño](https://s3.amazonaws.com/bigdatamx/TDSP27-connected-cars-3.4hh.png)

25. Cambie el **Título** del gráfico a **Media de combustible, media de temperatura del motor y recuento de vin por modelo**.

    ![Título del gráfico de dispersión](https://s3.amazonaws.com/bigdatamx/TDSP28-connected-cars-3.4ii.png)

    El informe final es similar al ejemplo siguiente:

    ![Informe final](https://s3.amazonaws.com/bigdatamx/TDSP29-connected-cars-3.4jj.png)
...
1. Cree un panel en blanco; para ello, seleccione el símbolo del signo más situado junto a **Paneles**. Escriba el nombre **Panel de análisis de telemetría de vehículos**.
    ...
    ![Símbolo del signo más en el panel](https://s3.amazonaws.com/bigdatamx/TDSPconnected-cars-3.5.png)

2. Ancle las visualizaciones de los informes anteriores al panel. 

    ![Símbolo de anclaje al panel](https://s3.amazonaws.com/bigdatamx/TDSP30-connected-cars-3.6.png)
    ...
    ![Panel con informes](https://s3.amazonaws.com/bigdatamx/TDSP31-connected-cars-4.0.png)
...
2. Seleccione **Editar consultas**.
    ...
    ![Editar consultas](https://s3.amazonaws.com/bigdatamx/TDSP32-edit-powerbi-query.png)

3. Haga doble clic en **Origen**.

    ![Origen](https://s3.amazonaws.com/bigdatamx/TDSP33-set-powerbi-source.png)
...
5. Establezca **Base de datos** como **connectedcar**.
    ...
    ![Base de datos](https://s3.amazonaws.com/bigdatamx/TDSP34-set-powerbi-database.png)
...
8. Especifique los valores de **Nombre de usuario** y **Contraseña** de su instancia de Azure SQL Database que ha especificado durante la configuración de su implementación.
    ...
    ![Credenciales de base de datos](https://s3.amazonaws.com/bigdatamx/TDSP35-provide-database-credentials.png)
...
12. Seleccione **Cerrar** para cerrar el archivo de Power BI Desktop.
    ...
    ![cierre](https://s3.amazonaws.com/bigdatamx/TDSP36-close-powerbi-desktop.png)
...
6. Ancle los gráficos a un nuevo panel denominado **Panel de análisis de telemetría de vehículos** en Power BI. Seleccione el panel en blanco que se creó anteriormente y, a continuación, vaya a la sección **Informes**. Seleccione el informe recién cargado.  
    ...
    ![Nuevo panel de Power BI](https://s3.amazonaws.com/bigdatamx/TDSP37-vehicle-telemetry-dashboard1.png) 
    ...
    ![Informe de Power BI con seis páginas](https://s3.amazonaws.com/bigdatamx/TDSP38-vehicle-telemetry-dashboard2.png)

7. En la **página 3**, ancle el siguiente contenido:  

    a. **Recuento de vin**  

   ![Página 3: Recuento de vin](https://s3.amazonaws.com/bigdatamx/TDSP39-vehicle-telemetry-dashboard3.png)

    b. **Vehículos que se han conducido de forma agresiva por modelo: gráfico de cascada** 

   ![Página 3: Gráfico 4](https://s3.amazonaws.com/bigdatamx/TDSP40-vehicle-telemetry-dashboard4.png)

8. En la **página 5**, ancle el siguiente contenido: 

    a. **Recuento de vin**

   ![Página 5: Gráfico 5](https://s3.amazonaws.com/bigdatamx/TDSP41-vehicle-telemetry-dashboard5.png)

    b. **Vehículos con ahorro de combustible por modelo: gráfico de columnas agrupadas**

   ![Página 5: Gráfico 6](https://s3.amazonaws.com/bigdatamx/TDSP42-vehicle-telemetry-dashboard6.png)

9. En la **página 4**, ancle el siguiente contenido:  

    a. **Recuento de vin** 

   ![Página 4: Gráfico 7](https://s3.amazonaws.com/bigdatamx/TDSP43-vehicle-telemetry-dashboard7.png) 

    b. **Vehículos retirados por ciudad y modelo: gráfico de rectángulos**

   ![Página 4: Gráfico 8](https://s3.amazonaws.com/bigdatamx/TDSP44-vehicle-telemetry-dashboard8.png)  

10. En la **página 6**, ancle el siguiente contenido:  

    * **Logotipo de Contoso Motors**

    ![Logotipo de Contoso Motors](https://s3.amazonaws.com/bigdatamx/TDSP45-vehicle-telemetry-dashboard9.png)
...
2. Mantenga el puntero sobre cada gráfico. Cambie el nombre de cada gráfico según la denominación proporcionada en el siguiente ejemplo de panel terminado:
   ...
   ![Organización de panel](https://s3.amazonaws.com/bigdatamx/TDSP46-vehicle-telemetry-organize-dashboard2.png) 
   
3. Mueva los gráficos de modo similar al siguiente ejemplo de panel:

    ![Panel reorganizado](https://s3.amazonaws.com/bigdatamx/TDSP47-vehicle-telemetry-dashboard.png)
...
4. Después de crear todos los informes que se mencionan en este documento, el panel terminado final es similar al ejemplo siguiente: 
   ...
   ![Panel final](https://s3.amazonaws.com/bigdatamx/TDSP48-vehicle-telemetry-organize-dashboard3.png)
