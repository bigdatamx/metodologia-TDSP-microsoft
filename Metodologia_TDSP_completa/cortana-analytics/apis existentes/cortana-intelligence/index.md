---
title: Herramienta de evaluación de soluciones Cortana Intelligence
---
...
![Herramienta de evaluación abierta](https://s3.amazonaws.com/bigdatamx/TDSP-1-open-evaluation-tool.png)

Especifique la información de identificación de la solución.

![Conexión a suscripción de Azure](https://s3.amazonaws.com/bigdatamx/TDSP-2-connect-azure-subscription.png)

Conéctese a la suscripción de Azure y especifique el grupo de recursos que contiene la aplicación.

![Selección de recursos](https://s3.amazonaws.com/bigdatamx/TDSP-3-select-resources.png)
...
![Establecimiento de requisitos previos](https://s3.amazonaws.com/bigdatamx/TDSP-4-set-test-prerequisites.png)
...
![Establecimiento de ejecución de pruebas](https://s3.amazonaws.com/bigdatamx/TDSP-5-set-test-execution.png)
...
![Justificación comercial](https://s3.amazonaws.com/bigdatamx/TDSP-6-provide-business-justification.png)
...
![Puntuación de la herramienta de evaluación](https://s3.amazonaws.com/bigdatamx/TDSP-7-grade-evaluation-tool.png)
