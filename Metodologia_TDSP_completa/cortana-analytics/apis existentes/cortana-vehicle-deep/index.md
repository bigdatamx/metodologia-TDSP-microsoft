---
title: Profundización en la predicción del estado de vehículo y los hábitos de conducción: Azure 
---
...
![Simulador telemático de vehículo](https://s3.amazonaws.com/bigdatamx/TDSP1-vehicle-telematics-simulator.png)
...
![Panel del Centro de eventos](https://s3.amazonaws.com/bigdatamx/TDSP4-vehicle-telematics-event-hub-dashboard.png) 
...
![Procesamiento de datos del trabajo de Stream Analytics](https://s3.amazonaws.com/bigdatamx/TDSP5-vehicle-telematics-stream-analytics-job-processing-data.png) 
...
![Consulta de trabajo de Stream Analytics para la ingesta de datos](https://s3.amazonaws.com/bigdatamx/TDSP6-vehicle-telematics-stream-analytics-job-query-for-data-ingestion.png) 
...
![Datos de muestra preparados para el flujo de trabajo de procesamiento por lotes](https://s3.amazonaws.com/bigdatamx/TDSP7-vehicle-telematics-prepare-sample-data-for-batch-processing.png) 


La canalización consta de una actividad .NET de Data Factory.

![Actividad PrepareSampleDataPipeline](https://s3.amazonaws.com/bigdatamx/TDSP8-vehicle-telematics-prepare-sample-data-pipeline.png) 
...
![Resultados de PrepareSampleDataPipeline](https://s3.amazonaws.com/bigdatamx/TDSP9-vehicle-telematics-prepare-sample-data-pipeline-output.png) 
...
![Flujo de trabajo de eventos de automóvil de partición](https://s3.amazonaws.com/bigdatamx/TDSP10-vehicle-telematics-partition-car-events-workflow.png)
...
![Actividad PartitionCarEventsPipeline](https://s3.amazonaws.com/bigdatamx/TDSP11-vehicle-telematics-partition-car-events-pipeline.png)
...
![Salida con particiones](https://s3.amazonaws.com/bigdatamx/TDSP12-vehicle-telematics-partitioned-output.png)
...
![Consulta de Stream Analytics para el procesamiento en tiempo real](https://s3.amazonaws.com/bigdatamx/TDSP13-vehicle-telematics-stream-analytics-query-for-real-time-processing.png)
...
* Escucha a una instancia de Event Hubs donde Stream Analytics publica los eventos en un patrón de forma continua.
    ...
    ![Consulta de Stream Analytics para la publicación de los datos]( 	https://s3.amazonaws.com/bigdatamx/TDSP14-vehicle-telematics-stream-analytics-query-for-publishing.png) 
...
1. Extraiga RealtimeDashboardApp guárdela en la máquina local.
    ...
    ![Carpeta RealTimeDashboardApp](https://s3.amazonaws.com/bigdatamx/TDSP16-vehicle-telematics-realtimedashboardapp-folder.png) 
...
3. Escriba sus credenciales válidas de Power BI y seleccione **Iniciar sesión**.  
    ...
    ![Ventana de inicio de sesión de la aplicación de panel en tiempo real](https://s3.amazonaws.com/bigdatamx/TDSP17a-vehicle-telematics-realtimedashboardapp-sign-in-to-powerbi.png) 
    
4. Seleccione **Aceptar**.

    ![Ventana de inicio de sesión final de la aplicación de panel en tiempo real](https://s3.amazonaws.com/bigdatamx/TDSP17b-vehicle-telematics-realtimedashboardapp-sign-in-to-powerbi.png) 
...
![Flujo de trabajo del patrón de comportamiento agresivo al volante](https://s3.amazonaws.com/bigdatamx/TDPS18-vehicle-telematics-aggressive-driving-pattern.png) 
...
![Resultados de AggressiveDrivingPatternPipeline](https://s3.amazonaws.com/bigdatamx/TDSP19-vehicle-telematics-aggressive-driving-pattern-output.png) 
...
![Patrón de conducción con consumo eficiente de combustible](https://s3.amazonaws.com/bigdatamx/TDSP19-vehicle-telematics-fuel-efficient-driving-pattern.png) 
...
![Resultados de FuelEfficientDrivingPatternPipeline](https://s3.amazonaws.com/bigdatamx/TDSP20-vehicle-telematics-fuel-efficient-driving-pattern-output.png) 
...
![Punto de conexión de Machine Learning](https://s3.amazonaws.com/bigdatamx/TDSP21-vehicle-telematics-machine-learning-endpoint.png) 
...
![Actividad de puntuación por lotes de Machine Learning en Data Factory](https://s3.amazonaws.com/bigdatamx/TDSP22-vehicle-telematics-aml-batch-scoring.png)  
...
![DetectAnomalyPipeline para la predicción de la retirada](https://s3.amazonaws.com/bigdatamx/TDSP23-vehicle-telematics-pipeline-predicting-recalls.png)  
...
![Resultados de DetectAnomalyPipeline](https://s3.amazonaws.com/bigdatamx/TDSP24-vehicle-telematics-detect-anamoly-pipeline-output.png) 
...
![Trabajo de Stream Analytics publicado en una instancia de Event Hubs de resultados](https://s3.amazonaws.com/bigdatamx/TDSP25-vehicle-telematics-stream-analytics-job-publishes-output-event-hub.png)

La siguiente consulta de Stream Analytics se usa para publicar resultados en la instancia de Event Hubs:

![Consulta de Stream Analytics para publicar en la instancia de Event Hubs de resultados](https://s3.amazonaws.com/bigdatamx/TDSP26-vehicle-telematics-stream-analytics-query-publish-output-event-hub.png)
...
![Copia de los resultados del procesamiento por lotes en el flujo de trabajo de data mart](https://s3.amazonaws.com/bigdatamx/TDSP27-vehicle-telematics-batch-processing-results-copy-to-data-mart.png)

El trabajo de Stream Analytics se publica en el data mart.

![Trabajo de Stream Analytics publicado en el data mart](https://s3.amazonaws.com/bigdatamx/TDSP28-vehicle-telematics-stream-analytics-job-publishes-to-data-mart.png)

El valor del data mart se encuentra en el trabajo de Stream Analytics.

![Ajuste de puesto de datos en el trabajo de Stream Analytics](https://s3.amazonaws.com/bigdatamx/TDSP29-vehicle-telematics-data-mart-setting-in-stream-analytics-job.png)
...
![Panel de Power BI](https://s3.amazonaws.com/bigdatamx/TDSP30-vehicle-telematics-powerbi-dashboard.png)
